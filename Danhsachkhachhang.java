...
public class Danhsachkhachhang extends JFrame {
    ...
    public Danhsachkhachhang() {
        ...
        // Tiêu đề
        JLabel titlePanel = new JLabel("Danh sách các Khách hàng");
        ...
        JButton themButton = new JButton("Thêm Khách hàng");
        ...
        topPanel.add(new JLabel("Tìm Khách hàng:"));
        ...
        String[] columns = {"STT", "Họ và tên", "Mã khách hàng", "Số điện thoại"};
        Object[][] data = {
            {1,"Nguyễn Văn A", "KH20230608230022", "0325647248"},
            {2,"Lê Văn B", "KH20230608230124", "01247530"},
            {3,"Nguyễn Văn C", "KH20230608230125", "057832486"},
        };
    ...
    public static void main(String[] args) {
            ...
            Danhsachkhachhang frame = new Danhsachkhachhang();
